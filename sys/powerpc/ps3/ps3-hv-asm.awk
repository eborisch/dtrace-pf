...
# $FreeBSD: release/10.1.0/sys/powerpc/ps3/ps3-hv-asm.awk 228688 2011-12-18 16:53:03Z nwhitehorn $

BEGIN {
	printf("/* $FreeBSD: release/10.1.0/sys/powerpc/ps3/ps3-hv-asm.awk 228688 2011-12-18 16:53:03Z nwhitehorn $ */\n\n");
