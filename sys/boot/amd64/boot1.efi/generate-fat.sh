...
# $FreeBSD: release/10.1.0/sys/boot/amd64/boot1.efi/generate-fat.sh 271136 2014-09-04 21:05:04Z emaste $
...
echo '# $FreeBSD: release/10.1.0/sys/boot/amd64/boot1.efi/generate-fat.sh 271136 2014-09-04 21:05:04Z emaste $' >> Makefile.fat
...
echo '$FreeBSD: release/10.1.0/sys/boot/amd64/boot1.efi/generate-fat.sh 271136 2014-09-04 21:05:04Z emaste $' >> $OUTPUT_FILE.bz2.uu
