...
# $FreeBSD: release/10.1.0/sys/boot/powerpc/boot1.chrp/generate-hfs.sh 226436 2011-10-16 14:30:28Z eadler $
...
echo '# $FreeBSD: release/10.1.0/sys/boot/powerpc/boot1.chrp/generate-hfs.sh 226436 2011-10-16 14:30:28Z eadler $' >> Makefile.hfs
...
echo '$FreeBSD: release/10.1.0/sys/boot/powerpc/boot1.chrp/generate-hfs.sh 226436 2011-10-16 14:30:28Z eadler $' >> $OUTPUT_FILE.bz2.uu
