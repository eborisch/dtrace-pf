...
# $FreeBSD: release/10.1.0/release/powerpc/generate-hfs.sh 221465 2011-05-04 23:34:10Z nwhitehorn $
...
echo '$FreeBSD: release/10.1.0/release/powerpc/generate-hfs.sh 221465 2011-05-04 23:34:10Z nwhitehorn $' >> $OUTPUT_FILE.bz2.uu
